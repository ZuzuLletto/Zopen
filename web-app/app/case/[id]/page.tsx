  ...
  if (!caseData) {
    return (
      <div className="text-center py-20">
        <h1 className="text-3xl font-bold text-white mb-4">Case Not Found</h1>
        <button
          onClick={() => router.push('/')}
          className="bg-primary text-black px-6 py-3 rounded-lg font-semibold hover:bg-primary-dark"
        >
          Back to Cases
        </button>
      </div>
